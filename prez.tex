...
\date{\footnotesize 24 oktober 2024}
...
\section{Porovnanie projektov AAA a nezávislých projektov}
% príkaz \ssection by vytvoril zvláštný slajd s názvom časti - v krátkych prezentáciách to prekáža, lebo oberá o čas

\begin{frame}[fragile=singleslide]\frametitle{AAA}
\begin{itemize}
\item Co je aaa
\item Process tvorby
	\begin{itemize}
	\item Nieco o projektach
	\item Priklady
	\end{itemize}
\item Alokacia
\end{itemize}
\end{frame}
\begin{frame}[fragile=singleslide]\frametitle{Indi}
\begin{itemize}
\item Coje Indi
\item Process tvorby
	\begin{itemize}
...
\section{Relevantnosť systému odporúčaní}

\begin{frame}[fragile=singleslide]\frametitle{Ďalší slajd}
\begin{itemize}
\item preco nie
\item Preco -- \emph{Ano}
\item \emp{Nie je to doulezite} % príkaz definovaný v preambule
...
\includegraphics[scale=.20]{Use-of-AI-Recommendation-in-Gaming-industry.jpg}
